  ...
  return (
    <>
      <style>{`
        ...
        .lp-logo-mark{width:44px;height:44px;border-radius:11px;background:#fff;display:flex;align-items:center;justify-content:center;flex-shrink:0;padding:4px}
            ...
            <Reveal delay={80}>
              <div className="lp-contact-grid">
                <div className="lp-contact-info">
                  ...
                  <div className="lp-contact-detail"><div className="lp-contact-detail-icon"><MessageCircle size={15} /></div>suporte@mestroo.ao</div>
                  <div className="lp-contact-detail"><div className="lp-contact-detail-icon"><MapPin size={15} /></div>Luanda, Angola</div>
                  <div className="lp-contact-detail"><div className="lp-contact-detail-icon"><Globe size={15} /></div>mestroo.ao</div>
                </div>
                <div>
                  {formSent ? (
                    <div className="lp-form-success"><p>✓ Mensagem enviada! Respondemos em breve.</p></div>
                  ) : (
                    <div className="lp-form">
                      <div className="lp-form-row">
                        <div className="lp-field"><label>Nome</label><input type="text" placeholder="O seu nome" value={form.nome} onChange={e => setForm({ ...form, nome: e.target.value })} /></div>
                        <div className="lp-field"><label>Email</label><input type="email" placeholder="seu@email.com" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} /></div>
                      </div>
                      <div className="lp-field"><label>Assunto</label><input type="text" placeholder="Sobre o que quer falar?" value={form.assunto} onChange={e => setForm({ ...form, assunto: e.target.value })} /></div>
                      <div className="lp-field"><label>Mensagem</label><textarea rows={5} placeholder="Escreva a sua mensagem aqui..." value={form.mensagem} onChange={e => setForm({ ...form, mensagem: e.target.value })} /></div>
                      <button className="lp-form-submit" onClick={handleSubmit}><Send size={15} /> Enviar mensagem</button>
                    </div>
                  )}
                </div>
              </div>
