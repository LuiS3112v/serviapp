  ...
  return (
    <>
      <style>{`
        ...
        .legal-hero{display:flex;align-items:center;gap:16px;padding:22px 26px;border-radius:20px;color:#fff;box-shadow:0 14px 30px rgba(37,99,235,0.22)}
        ...
        .legal-toc-link:hover{background:#f0fdf9;color:#1D9E75}
      ...
      <div className="legal-page">
        ...
        <main className="legal-body">
          <div className="legal-inner">
            <div className="legal-hero" style={{ background: "linear-gradient(120deg,#2563eb,#1D9E75)" }}>
              <div className="legal-hero-icon"><Lock size={22} color="#fff"/></div>
              <div>
            ...
            <div className="legal-layout">
              ...
              <div className="legal-content">
                {sections.map((s, i) => {
                  const c = ACCENTS[i % 3];
                  return (
                    <section id={`p-sec-${i}`} className="legal-card" key={i} style={{ animationDelay: `${i * 40}ms` }}>
