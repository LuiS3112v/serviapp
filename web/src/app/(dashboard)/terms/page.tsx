...
export default function TermsPage() {
  ...
  return (
    <>
      <style>{`
        .terms-wrap{display:flex;min-height:100vh;background:#0d1117}
        ...
        <div className="terms-main">
          ...
          <div className="terms-inner">
            ...
            <div style={{display:"flex",alignItems:"center",gap:12,padding:"16px 20px",borderRadius:14,background:"#0b2a2a",border:"1px solid #1d9e7525"}}>
              ...
              <div>
                <p style={{fontSize:14,fontWeight:600,color:"#c0d0e0"}}>Termos de Serviço</p>
                <p style={{fontSize:12,color:"#4a7a7a"}}>Última actualização: 2026 · Serviapp Angola</p>
              </div>
            </div>
            {sections.map((s,i)=>(
