  ...
  return (
    <>
      <style>{`
        ...
        .back-btn{display:inline-flex;align-items:center;gap:6px;font-size:14px;font-weight:600;color:#0F172A;background:#fff;border:1px solid #E2E8F0;cursor:pointer;margin-top:4px;margin-bottom:20px;font-family:inherit;padding:10px 16px;border-radius:10px;width:fit-content;align-self:flex-start}
