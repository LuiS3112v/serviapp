...
const groups = [
  { title:"Conta", items:[
    ...
    { icon:Smartphone, label:"Verificação de identidade", desc:"KYC — selfie e documento de identidade", color:"#EF9F27" },
  ]},
  { title:"Preferências", items:[
    { icon:Bell, label:"Notificações", desc:"Gere as tuas preferências de notificação", color:"#378ADD" },
  ...
  return (
    <>
      ...
      <div className="pset-inner">
        ...
        <div className="set-group">
          <div className="set-item" onClick={()=>router.push("/")}>
