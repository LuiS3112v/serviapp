      ...
      <div className="pp-inner">
        ...
        >
          <div>
            ...
            >
              Gere o teu perfil profissional
            </p>
          </div>
        ...
        >
          ...
          <div style={{flex:1}}>
            ...
            >
              Completa o KYC para activar o teu perfil e começar a receber clientes.
            </p>

            <button
              className="kyc-btn"
              onClick={() => router.push("/kyc?role=provider")}
            >
