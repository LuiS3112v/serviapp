...
export default function ProviderTransactionsPage() {
  ...
  return (
    <>
      <style>{`
        .pt-inner{padding:28px 32px;display:flex;flex-direction:column;gap:20px;max-width:800px}
        ...
        @media(max-width:640px){.pt-inner{padding:16px}.tabs{width:100%}.tab{flex:1;text-align:center}}
      `}</style>
      <div className="pt-inner">
        ...
        <div className="empty">
          ...
          <p style={{fontSize:13,color:"#4a6a6a",lineHeight:1.6,maxWidth:280}}>Os teus movimentos vão aparecer aqui.</p>
        </div>
      </div>
    </>
  );
