  ...
  return (
    <nav style={{ position:"sticky",top:0,zIndex:30,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 28px",height:64,background:"#080e1a",borderBottom:"1px solid #1a2535" }}>
      <div style={{ display:"flex",alignItems:"center",gap:10,background:"#0d1520",border:"1px solid #1a2535",borderRadius:12,padding:"10px 16px",flex:1,maxWidth:480 }}>
        ...
        <input placeholder="Pesquise clientes, serviços ou pedidos..." style={{ background:"none",border:"none",outline:"none",fontSize:14,color:"#8a9ab0",width:"100%",fontFamily:"inherit" }} />
      </div>
      <div style={{ display:"flex",alignItems:"center",gap:12,marginLeft:20 }}>
        ...
        <div style={{ position:"relative",cursor:"pointer" }} onClick={() => router.push("/provider/notifications")}>
        ...
        <div onClick={() => router.push("/provider/profile")} style={{ width:40,height:40,borderRadius:12,background:"#2a1e08",border:"1px solid #EF9F2740",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,color:"#EF9F27",cursor:"pointer" }}>P</div>
      </div>
    </nav>
  );
}