...
import {
  Home, BarChart3, Briefcase, MessageCircle, Bell,
  Wallet, Receipt, User, Settings, LogOut, Zap, Users, Star, PlusCircle
} from "lucide-react";
        ...
        {navItems.map(group => (
          <div key={group.section} style={{ marginBottom:8 }}>
            ...
            {group.items.map(item => {
              ...
              return (
                <Link key={item.href} href={item.href} style={{ display:"flex",alignItems:"center",gap:12,padding:"11px 20px",fontSize:14,fontWeight:500,color:active?"#EF9F27":"#6a7a8a",background:active?"#EF9F2712":"transparent",borderLeft:active?"3px solid #EF9F27":"3px solid transparent",textDecoration:"none",transition:"all 0.15s" }}>
                  <Icon size={18} />
